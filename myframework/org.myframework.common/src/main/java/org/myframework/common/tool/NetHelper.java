 ...
 * File Name:NetHelper.java <br>
 * Package Name:org.myframework.common.tool <br>
 * @author xiezbmf
 * Date:2017年6月27日下午3:18:56 <br>
...
import org.myframework.common.constant.CommonConst;
...
public class NetHelper {
	...
	/**
	 * getIpAddr: 获取Ip地址，先取X-Forwarded-For地址，如果为空， <br>
	 ...
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:38:46 <br>
	 * @param request
	 * @return
	 */
	 ...
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:44:54 <br>
	 * @param is
	 * @return
	 */
	public static byte[] getByteByStream(InputStream is) {
		...
		try {
			...
			log.error(String.format(LogTemplate.COMMON_SYS_FAIL, cmd,
					"getByteByStream is failed"), e);
			return null;
		} finally {
			try {
				if (out != null) {
				...
				log.error(String.format(LogTemplate.COMMON_SYS_FAIL, cmd,
						"getByteByStream close outstream is failed"), e);
			}
		}
	}
	 ...
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:46:01 <br>
	 * @param is
	 * @return
	 */
	 ...
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:47:04 <br>
	 * @param is
	 * @param encode
	 * @return
	 */
	 ...
	 * @see ConfigConst.DEFAULT_ENCODE
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:47:47 <br>
	 * @param bytes
	 * @return
	 */
	 ...
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:48:55 <br>
	 * @param bytes
	 * @param encode
	 * @return
	 */
	 ...
	 * 
	 * @see ConfigConst.DEFAULT_ENCODE
	 * @author xiezbmf Date:2016年9月12日下午4:49:44 <br>
	 * @param requestUrl
	 *            请求url
	 * @param cookie
	 *            请求cookie
	 ...
	 * @return
	 */
	public static String httpPostData(String requestUrl, String cookie,
			String data) {
		...
		try {
			...
			log.error(String.format(LogTemplate.COMMON_SYS_FAIL, cmd,
					"httpPostData is failed，responseCode is " + responseCode),
					e);
		} finally {
			try {
				if (inPs != null) {
				...
				log.error(String.format(LogTemplate.COMMON_SYS_FAIL, cmd,
						"httpPostData close input stream is failed"), e);
			}
			...
			try {
				...
				log.error(String.format(LogTemplate.COMMON_SYS_FAIL, cmd,
						"httpPostData close output stream is failed"), e);
			}
	 ...
	 * 
	 * @author xiezbmf Date:2016年9月12日下午4:51:21 <br>
	 * @param in
	 * @return
	 */
	private static byte[] unzip(InputStream in) {
		...
		try {
			...
			try {
				...
				log.error(String.format(LogTemplate.COMMON_SYS_FAIL, cmd,
						"unzip close out gin is failed"), e);
			}
